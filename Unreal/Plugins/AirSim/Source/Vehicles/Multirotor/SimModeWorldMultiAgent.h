...
#include "SimModeWorldMultiAgent.generated.h"

UCLASS()
class AIRSIM_API ASimModeWorldMultiAgent : public ASimModeWorldBase
{
    GENERATED_BODY()
...
protected: //overrides
    ...
    //virtual std::unique_ptr<msr::airlib::ApiServerBase> createApiServer() const override; ---> This Line is from the original SimModeWorldMultiRotor.h file
